...
if($modo=="pt") { $contarposts2 = mysql_query ( "SELECT * FROM blog WHERE tag1='$tag' OR tag2='$tag' OR tag3='$tag' ORDER BY dataordem DESC" );
...
//-->
	 ...
	 $contarposts2 = mysql_query ( "SELECT * FROM blog2 WHERE tag1='$tag' OR tag2='$tag' OR tag3='$tag' ORDER BY dataordem DESC " );
 $nrposts2=mysql_num_rows($contarposts2);
  if($tag=="" or $nrposts2==0) { echo '<script type="text/javascript">
...
if($modo=="pt") {
	$result = mysql_query("SELECT * FROM blog WHERE tag1='$tag' OR tag2='$tag' OR tag3='$tag' ORDER BY dataordem DESC");

	} else { 	$result = mysql_query("SELECT * FROM blog2 WHERE tag1='$tag' OR tag2='$tag' OR tag3='$tag' ORDER BY dataordem DESC"); }
...
<li><a href="fotofilme.php">Foto/Filme</a></li>
	...
	<div id="page">
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="content">
                <h3 class="red3">tags com a palavra <?php echo $tag; ?>.</h2>
                <?php
